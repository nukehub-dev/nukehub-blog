...
<DataTable
  columns={[
    ...
    { key: "disk", header: "Disk", align: "right" },
    { key: "cost", header: "Cost", align: "right" },
    { key: "best", header: "Best for" },
  ]}
  data={[
    { plan: "Small", cpu: "2 cores", memory: "4 GB", disk: "20 GB", cost: "1 NUKE/hr", best: "Light analysis, notebooks, and quick experiments" },
    { plan: "Medium", cpu: "4 cores", memory: "8 GB", disk: "50 GB", cost: "2 NUKE/hr", best: "Standard simulations and data processing workflows" },
    { plan: "Large", cpu: "8 cores", memory: "16 GB", disk: "100 GB", cost: "4 NUKE/hr", best: "Heavy parallel CPU workloads and longer runs" },
    { plan: "XLarge", cpu: "16 cores", memory: "32 GB", disk: "200 GB", cost: "8 NUKE/hr", best: "Maximum resources — admin approval required" },
  ]}
  caption="The four built-in resource plans. Plans also define max runtime, idle timeout, scheduling options, and per-user server limits."
/>
