...
This post is the full tour: how workspaces work, how the credit economy keeps shared hardware fair, how the security model is layered, and what is coming next.
...
<DataTable
  ...
  data={[
    ...
    { plan: "XLarge", cpu: "16 cores", memory: "32 GB", disk: "200 GB", cost: "8 NUKE/hr", best: "Maximum resources" },
  ]}
